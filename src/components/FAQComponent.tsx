...
const FAQSection = () => {
  ...
  return (
    <section id="faq" className="relative z-10 px-6 md:px-12 lg:px-20 pt-28 md:pt-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          {/* Left Side */}
          <div>
            {/* Section Label */}
            <div className="flex items-center gap-2 mb-8 justify-center  bg-white border border-dashed border-gray-200 w-fit rounded-full p-2 ">
